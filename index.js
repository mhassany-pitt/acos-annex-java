...
Annotated.register = function (handlers) {
  handlers.contentPackages['acos-annex-java'] = Annotated;
  handlers.contentTypes.annotated.installedContentPackages.push(Annotated);
};

Annotated.namespace = 'acos-annex-java';
Annotated.contentTypeNamespace = 'annotated';
Annotated.packageType = 'content';

Annotated.meta = {
  'name': 'acos-annex-java',
  'shortDescription': 'webex annotated examples for java',
  'description': '',
  'author': 'PAWS Lab',
  'license': 'MIT',
  'version': '0.0.1',
